...
class Data
{
    ...
    private function madeLinkJson($text = ["text", "link"], $link = null)
    {
    ...
    private function specialHtmlTag($tagName, $value = ["key" => "value",])
    {
...
$a = isset($_POST["dataName"]);
$data = new Data();
$background = $data->background([["text", "link"], ["test1", "test1"]], [["title", [["text", "link"], ["text", "link"]]], ["title", [["text", "link"], ["text1", "link1"]]], ["title", [["text", "link"], ["text1", "link1"]]]]);

$carousel = $data->carousel([["../img/1.jpg", "javascript:;"], ["../img/2.jpg", "javascript:;"]]);

$websiteItem = $data->websiteItem("https://www.google.com/favicon.ico", ["Google", "https://www.google.com"], "Google是全球最大搜索引擎，拥有全球数以十亿的用户，同时其下有产品Youtube,Gmail,Android等", [["google", "https://www.google.com"], ["搜索", "https://www.google.com"]]);

$titleTab = $data->titleTab(["标题", [["我的", "../my"], ["你的", "../you"]]]);
...
if ($a) {
    switch ($_POST["dataName"]) {
        ...
        case "websiteItem";
            {
                echo json_encode(["websiteItem" => [$websiteItem, $websiteItem, "multiple" => true]]);
//                echo $websiteItem;
                break;
            }
        case "titleTab";
            {
                ...
                echo json_encode(["titleTab" => [$titleTab, $titleTab, "multiple" => true]]);
//                echo $titleTab;
                break;
            }
